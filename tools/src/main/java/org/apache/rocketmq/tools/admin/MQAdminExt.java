...
/**
 * 在 RocketMQ 中，MQAdmin 是管理命令行工具，而 MQAdminExt 则是其扩展版本。
 * Ext 在这里代表的是 Extension，即扩展的意思，表示 MQAdminExt 拓展了 MQAdmin 的功能，
 * 提供了一些额外的管理命令和功能，方便用户进行更细粒度的管理和操作。因此，MQAdminExt 可以看作是 MQAdmin 的增强版
 */
